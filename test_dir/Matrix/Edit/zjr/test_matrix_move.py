...
class TestMatrixEditMove:
    ...
    def test_matrix_move (self, job_id):
        ...
        print("1",Information.get_layers(job_ep).index("drill.art"))
        print("2", Information.get_layers(job_ep).index("0114_1240_1_10.drl"))
